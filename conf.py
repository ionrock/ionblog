...
project = 'Ionrock Dot Org'

# Change this to the tagline of your blog
tagline = 'Programming and Music'

# Change this to the description of your blog
description = 'The Homepage of Eric Larson'
...
exclude_patterns = ["drafts/*", "_templates/*", "venv/*", ".venv/*"]
